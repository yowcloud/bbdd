...
-- Índice único en la tabla de Mitologías
CREATE UNIQUE INDEX idx_nombre_tipo ON mitologias(nombre_tipo);

-- Índice único en la tabla de Clasificación de Criaturas
CREATE UNIQUE INDEX idx_nombre_clasificacion ON clasificacion_criaturas(nombre_clasificacion_id);

-- Índice único en la tabla de Testigos
CREATE UNIQUE INDEX idx_numero_contacto ON testigos(numero_contacto);
